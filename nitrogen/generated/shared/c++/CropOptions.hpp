...
namespace margelo::nitro::nitroimagemarker {
  ...
  public:
    CropOptions() = default;
    explicit CropOptions(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroimagemarker::CropOptions> final {
    static inline margelo::nitro::nitroimagemarker::CropOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroimagemarker::CropOptions(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroimagemarker::CropOptions& arg) {
