...
namespace margelo::nitro::nitroimagemarker {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ImageMarkOptions).
   */
  struct ImageMarkOptions final {
  public:
    ImageOptions backgroundImage     SWIFT_PRIVATE;
    std::vector<WatermarkImageOptions> watermarkImages     SWIFT_PRIVATE;
    std::optional<std::vector<TextOptions>> watermarkTexts     SWIFT_PRIVATE;
  ...
  public:
    ImageMarkOptions() = default;
    explicit ImageMarkOptions(ImageOptions backgroundImage, std::vector<WatermarkImageOptions> watermarkImages, std::optional<std::vector<TextOptions>> watermarkTexts, std::optional<double> quality, std::optional<std::string> filename, std::optional<ImageFormat> saveFormat, std::optional<double> maxSize, std::optional<CropOptions> crop, std::optional<FilterOptions> filter, std::optional<std::vector<BlurRegion>> blurRegions, std::optional<TileOptions> tile): backgroundImage(backgroundImage), watermarkImages(watermarkImages), watermarkTexts(watermarkTexts), quality(quality), filename(filename), saveFormat(saveFormat), maxSize(maxSize), crop(crop), filter(filter), blurRegions(blurRegions), tile(tile) {}

  public:
    friend bool operator==(const ImageMarkOptions& lhs, const ImageMarkOptions& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ImageMarkOptions <> JS ImageMarkOptions (object)
  template <>
  struct JSIConverter<margelo::nitro::nitroimagemarker::ImageMarkOptions> final {
    static inline margelo::nitro::nitroimagemarker::ImageMarkOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroimagemarker::ImageMarkOptions(
        ...
        JSIConverter<std::vector<margelo::nitro::nitroimagemarker::WatermarkImageOptions>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "watermarkImages"))),
        JSIConverter<std::optional<std::vector<margelo::nitro::nitroimagemarker::TextOptions>>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "watermarkTexts"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroimagemarker::ImageMarkOptions& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "watermarkImages"), JSIConverter<std::vector<margelo::nitro::nitroimagemarker::WatermarkImageOptions>>::toJSI(runtime, arg.watermarkImages));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "watermarkTexts"), JSIConverter<std::optional<std::vector<margelo::nitro::nitroimagemarker::TextOptions>>>::toJSI(runtime, arg.watermarkTexts));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::vector<margelo::nitro::nitroimagemarker::WatermarkImageOptions>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "watermarkImages")))) return false;
      if (!JSIConverter<std::optional<std::vector<margelo::nitro::nitroimagemarker::TextOptions>>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "watermarkTexts")))) return false;
